                ...
                <Col className="pe-5" md="7">
                    <div className="mb-5">
                        ...
                        <div className="d-flex flex-row gap-2 mb-4">
                            <Badge className="p-2 bg-secondary" outline pill><i className="bi bi-person"></i> 15 Seats</Badge>
                            <Badge className="p-2" pill><i class="bi bi-clock"></i> 3N / 4D</Badge>
                            <Badge className="p-2" pill><i class="bi bi-person-check"></i> Age 18-40</Badge>
                        </div>
                        <p>
                        ...
                        <p><strong>Places covered - </strong> Delhi – Chandigarh - Chitkul - Nako – Dhankar - Kaza – Hikkim – Ki – Kibber – Chicham Bridge – Chandratal Lake - Kunzum pass – Manali</p>
                    </div>
                    <div className="mb-5">
