            ...
            <section className="container pt-5 pb-4 px-sm-4">
                <Row>
                    ...
                    <Col className="d-none d-md-block text-end" md="2" lg="2">
                        <Button className="hover-white" outline onClick={toggle}><i className="bi bi-share-fill pe-1"></i> Share</Button>
                    </Col>
                </Row>
                ...
                {places_covered && <small className="text-muted">Places Covered -{places_covered}</small>}
            </section>
